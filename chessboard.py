...
STOCKFISH_PATH = r"D:\Ai-bot-chess-master\stockfish\stockfish.exe"  # Make sure this path is correct
...
def draw_possible_moves(possible_moves):
    ...
    for move in possible_moves:
        ...
        pygame.draw.circle(screen, HIGHLIGHT_COLOR,
                           (col * SQUARE_SIZE + SQUARE_SIZE // 2, (7 - row) * SQUARE_SIZE + SQUARE_SIZE // 2), 15)
